          ...
          <div>
            ...
            <div className="space-y-8 border-l-2 border-gray-300 ml-3 pl-6">
              ...
              <div>
                ...
                <p className="text-gray-700 mt-2">Led week-long ISOC IXP workshops across Africa (Burkina Faso, Benin, Ethiopia, Mauritania, Congo Republic, Liberia). Trained 40+ renowned engineers, network operators, and policy makers in each country.</p>
              </div>
            </div>
          </div>
        </FadeIn>
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {["Python", "Go", "C/C++", "LateX", "Matlab", "R", "Rust (Ongoing)"].map((skill) => (
